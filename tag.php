   ...
   <div class="row">
        <div id="post-<?php the_ID(); ?>" <?php post_class( 'col-lg-8' ); ?>>
            <?php the_post(); ?>  
                ...
                <?php if ( is_day() ) : ?>
                     <h1 class="page-title"><?php _e( 'Tag Archives:', 'compontoweb' ) ?> <span><?php single_tag_title() ?></span></h1>
                    <?php 
                ...
                <?php endif; ?>
                        ...
                        <?php while ( have_posts() ) : the_post(); ?>
                          ...
                          <div class="entry-utility">
                                ...
                                <?php if ( $compontoweb_tag = compontoweb_tag(', ') ) : // Retorna tags excepto a pesquisada ?>
                                    <span class="tag-links"><?php printf( __( 'Also tagged %s', 'compontoweb' ), $compontoweb_tag ) ?></span>
                                <?php endif; ?>
                            <span class="meta-sep"> | </span>
